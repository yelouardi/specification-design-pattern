 ...
 */
public class AndSpecification extends AbstractSpecification implements ISpecification {

    private ISpecification abstractSpecification;
    private ISpecification specification;
    public AndSpecification(ISpecification abstractSpecification, ISpecification specification) {
